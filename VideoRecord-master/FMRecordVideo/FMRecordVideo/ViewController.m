...
- (IBAction)fileOut:(id)sender {
    ...
    FMNavigationController *NAV = [[FMNavigationController alloc] initWithRootViewController:fileVC];
...
//    FMNavigationController *NAV = [[FMNavigationController alloc] initWithRootViewController:writeVC];
//    [self presentViewController:NAV animated:YES completion:nil];
